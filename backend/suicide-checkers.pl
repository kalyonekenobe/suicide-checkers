...
% look_ahead_on(+Integer)
% Максимальна кількість полуходів
look_ahead_on(4).

% initial_board(board(-[fig(-Type, -Integer, -Integer)], -[fig(-Type, -Integer, -Integer)]))
% Початкова дошка
...
% evaluate_board(board(-[fig(+Type, +Integer, +Integer)]), -Integer)
% Оцінка дошки
...
% Допоміжні предикати для списків
% list_member(+[Integer], +Integer)
list_member(List, Member)               :- member(Member, List).
% list_append(+[Integer], +[Integer], -[Integer])
list_append(List1, List2, Result)       :- append(List1, List2, Result).
% list_delete_one(+Integer, +[Integer], -[Integer])
...
% fig(+(man | king), +Integer, +Integer)
fig(man, X, Y)  :- pos(X, Y).
fig(king, X, Y) :- pos(X, Y).

% diagonal_is_free(+[fig(+(man | king), +Integer, +Integer)], +Integer, +Integer, +Integer, +Integer)
...
% possible_move(+side(white | black), +fig(+(man | king), +Integer, +Integer), -fig(-(man | king), -Integer, -Integer))
...
% way_is_free(+[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)], +fig(+(man | king), +Integer, +Integer), -fig(-(man | king), -Integer, -Integer))
...
% move_figure(+side(white | black), +[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)], -[fig(+(man | king), +Integer, +Integer)])
...
% diagonal_positions(+pos(+Integer, +Integer), +Integer, +Integer, -[pos(-Integer, -Integer)])
...
% possible_capture(+side(white | black), +fig(+(man | king), +Integer, +Integer), +fig(+(man | king), +Integer, +Integer), -fig(-(man | king), -Integer, -Integer))
...
% way_for_capture_is_free(+[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)], +fig(+(man | king), +Integer, +Integer), +fig(+(man | king), +Integer, +Integer), -fig(-(man | king), -Integer, -Integer))
...
% potential_intermediate_king_pos(+side(white | black), +[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)], +pos(+Integer, +Integer), +pos(+Integer, +Integer), -pos(-Integer, -Integer))
...
% potential_intermediate_king_pos_with_capture(+side(white | black), +[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)], +pos(+Integer, +Integer), +pos(+Integer, +Integer), -pos(-Integer, -Integer))
...
% potential_intermediate_king_pos_list(+side(white | black), +[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)], +pos(+Integer, +Integer), +pos(+Integer, +Integer), -pos(-Integer, -Integer))
...
% allowable_intermediate_capture_pos(+side(white | black), +[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)], +fig(+(man | king), +Integer, +Integer), +fig(+(man | king), +Integer, +Integer), -fig(-(man | king), -Integer, -Integer))
...
% capture_single_figure(+side(white | black), +[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)], -[fig(-(man | king), -Integer, -Integer)], +[fig(+(man | king), +Integer, +Integer)], -[fig(-(man | king), -Integer, -Integer)], +fig(+(man | king), +Integer, +Integer), -fig(-(man | king), -Integer, -Integer))
...
% capture_figures(+side(white | black), +[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)], -[fig(-(man | king), -Integer, -Integer)], +[fig(+(man | king), +Integer, +Integer)], -[fig(-(man | king), -Integer, -Integer)], +fig(+(man | king), +Integer, +Integer), -fig(-(man | king), -Integer, -Integer))
...
% capture_multiple_figures(+side(white | black), +[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)], -[fig(-(man | king), -Integer, -Integer)], +[fig(+(man | king), +Integer, +Integer)], -[fig(-(man | king), -Integer, -Integer)], +fig(+(man | king), +Integer, +Integer), -fig(-(man | king), -Integer, -Integer))
...
% move_capture(+(black | white), +board(+[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)]), -board(-[fig(-(man | king), -Integer, -Integer)], -[fig(-(man | king), -Integer, -Integer)]))
...
% move(+(black | white), +board(+[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)]), +board(+[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)]))
...
% swap_node_type(+(min | max), -(min | max))
swap_node_type(min, max).
swap_node_type(max, min).

% best_score_and_board(+(min | max), +board(+[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)]), +Integer, +board(+[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)]), +Integer, -board(-[fig(-(man | king), -Integer, -Integer)], -[fig(-(man | king), -Integer, -Integer)]), -Integer)
...
% alpha_beta_prune(+(min | max), +Integer, +Integer, +Integer)
alpha_beta_prune(max, _, Beta, Value)  :- Value > Beta.
alpha_beta_prune(min, Alpha, _, Value) :- Value < Alpha.

% update_alpha_beta(+(min | max), +Integer, +Integer, +Integer, ?Integer, ?Integer)
...
% possible_moves_list(+side(white | black), +board(+[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)]), -[move(-(black | white), +board(+[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)]), -board(-[fig(-(man | king), -Integer, -Integer)], -[fig(-(man | king), -Integer, -Integer)]))])
possible_moves_list(Side, Board, List) :- findall(NewBoard, move(Side, Board, NewBoard), List).

% find_best_move(+side(white | black), +(min | max), +[board(+[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)])], -board(-[fig(-(man | king), -Integer, -Integer)], -[fig(-(man | king), -Integer, -Integer)]), -Integer, +Integer, +Integer, +Integer)
...
% minmax(+(black | white), +(min | max), +board(+[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)]), -board(-[fig(-(man | king), -Integer, -Integer)], -[fig(-(man | king), -Integer, -Integer)]), -Integer, +Integer, +Integer, +Integer)
...
% smart_move(+(black | white), +board(+[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)]), -board(-[fig(-(man | king), -Integer, -Integer)], -[fig(-(man | king), -Integer, -Integer)]))
...
% board_lists(+(black | white), +board(+[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)]), -[fig(-(man | king), -Integer, -Integer)], -[fig(-(man | king), -Integer, -Integer)])
board_lists(black, board(Black, White), Black, White).
board_lists(white, board(Black, White), White, Black).

% intermediate_diagonal_positions(+[pos(+Integer, +Integer)], +[pos(+Integer, +Integer)], -[pos(-Integer, -Integer)])
...
% intermediate_positions_from_path(+[pos(+Integer, +Integer)], -[pos(-Integer, -Integer)])
...
% subtract_figures_list(+[fig(+(man | king), +Integer, +Integer)],  +[pos(+Integer, +Integer)], -[fig(-(man | king), -Integer, -Integer)])
...
% subtract_figures(+board(+[fig(+(man | king), +Integer, +Integer)], +[fig(+(man | king), +Integer, +Integer)]), -board(-[fig(-(man | king), -Integer, -Integer)], -[fig(-(man | king), -Integer, -Integer)]), -[pos(-Integer, -Integer)])
...
% deduce_final_figure_type(+side(white | black), +(man | king), +(man | king), -[pos(-Integer, -Integer)])
